...
let usersData = [
  ...
  },
  {
    id: 5,
    name: "Thomas Petit",
    email: "thomas.petit@exemple.com",
    role: "user",
  ...
  },
  {
    id: 7,
    name: "David Laurent",
    email: "david.laurent@exemple.com",
    role: "user",
  ...
  },
  {
    id: 9,
    name: "Marc Lefevre",
    email: "marc.lefevre@exemple.com",
    role: "user",
...
function updateUserCount(totalUsers, currentPage) {
  ...
  document.getElementById("user-count").textContent =
    `Affichage de ${startIndex}-${endIndex} utilisateurs sur ${totalUsers}`;
}
      ...
      datasets: [
        {
          ...
          data: [
            650, 700, 800, 850, 900, 950, 1000, 1050, 1100, 1150, 1200, 1248,
          ],
          borderColor: "#3b82f6",
...
function animateStats() {
  const stats = {
    totalUsers: {
      element: document.getElementById("total-users"),
      target: 1248,
      duration: 2000,
    },
    newUsers: {
      element: document.getElementById("new-users"),
      target: 48,
      duration: 1500,
    },
    activityRate: {
      element: document.getElementById("activity-rate"),
      target: 68,
      duration: 1800,
    },
    avgTime: {
      element: document.getElementById("avg-time"),
      target: 4.2,
      duration: 1600,
    },
  };
...
function initModals() {
  ...
  addUserForm.addEventListener("submit", function (e) {
    ...
    const newId =
      usersData.length > 0 ? Math.max(...usersData.map((u) => u.id)) + 1 : 1;
    const colors = [
      "bg-blue-500",
      "bg-green-500",
      "bg-purple-500",
...
function initUserActions() {
  document.addEventListener("click", function (e) {
    ...
    if (e.target.closest(".edit-user")) {
      ...
      const user = usersData.find((u) => u.id === userId);
      alert(
        `Édition de l'utilisateur "${user.name}" (fonctionnalité en développement)`,
      );
    }
  ...
  document
    ...
    .addEventListener("change", function () {
      ...
      if (period === "week") {
        ...
        newData = [
          400, 500, 600, 700, 800, 900, 1000, 1100, 1150, 1200, 1220, 1248,
        ];
        labels = [
          "Jan",
          "Fév",
